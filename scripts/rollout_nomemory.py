...
from world_model.data.clip_dataset import ExportedClipWindowDataset
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a trained no-memory predictor on a single exported clip window.")
